...
func Register(app *fiber.App, deps Dependencies) {
	...
	appPagesHandler := handler.NewAppPagesHandler(deps.Config, deps.AuthService, deps.AdmissionsService, deps.ExerciseService, deps.ExerciseFavorite, deps.CareService, deps.ExamTemplateService, deps.PaymentService, deps.SettlementService, deps.ReportService, deps.WorkOrderService)
	...
	protected.Post("/reports/finance/export", middleware.RequirePermissions(domain.PermissionReportsExport), reportsHandler.ExportFinance)
	...
	protected.Post("/reports/audit/export", middleware.RequirePermissions(domain.PermissionReportsExport), governanceHandler.AuditExport)
	...
	ui.Get("/exercises/:exercise_id", middleware.RequirePermissions(domain.PermissionExercisesRead), appPagesHandler.ExerciseDetail)
	...
	ui.Post("/exercises/media/upload", middleware.RequirePermissions(domain.PermissionMediaWrite), mediaHandler.UploadAndRedirect)
	...
	ui.Post("/diagnostics/export", middleware.RequirePermissions(domain.PermissionDiagnosticsExport), diagnosticsHandler.ExportUI)
